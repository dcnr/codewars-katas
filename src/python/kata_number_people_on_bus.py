"""
Codewars Kata - Number of People in the Bus
...
def number(bus_stops: list[list[int]]) -> int:
    """Returns the number of people left in the bus at the last stop."""

    return sum([boarding - exiting for boarding, exiting in bus_stops])


if __name__ == "__main__":
    from doctest import testmod

    testmod(name="number", verbose=True)
