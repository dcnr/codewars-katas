...
def open_or_senior(data: list[list[int]]) -> list[str]:
    """Categorizes member entries into 'Open' or 'Senior'

    Args:
        data (list[list[int]]): The member list containing score and handicap.

    Returns:
        list[str]: The member classification, 'Open' or 'Senior'
    """
    return [
...
if __name__ == "__main__":
    ...
    testmod(name="open_or_senior", verbose=True)
