...
though individual spectators never move away from their seats. In many large
...
def wave(people: str) -> list[str]:
    """Emulate mexican wave

    Args:
        people (str): The people

    Returns:
        list[str]: The wave of people
    """

    return [
        people[:count] + person.upper() + people[count + 1 :]
...
if __name__ == "__main__":
    ...
    doctest.testmod(name="wave", verbose=True)
